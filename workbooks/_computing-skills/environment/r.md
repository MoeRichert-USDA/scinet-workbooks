---
title: "Managing packages and environments in R"
description: "Using the `renv` package for package management, and alternative methods for R."
...
In this tutprial, we will begin by using R from the command line. Later, we will cover similar steps using RStudio Server available on Open OnDemand. We will primarily focus on using the `renv` package for package management, but we will also note alternatives at the end. 
